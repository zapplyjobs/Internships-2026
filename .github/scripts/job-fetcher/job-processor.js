...
// Returns { ids: Set<jobId>, fingerprints: Set<fingerprint> }
    ...
    try {
        ...
        if (nonInternshipJobs.length > 0) {
            ...
            nonInternshipJobs.forEach(job => {
                console.log(`   ⏭️  [NOT INTERNSHIP] ${job.employer_name} - ${job.job_title}`);
            });
            console.log('');
        }
        ...
        // Create set of job IDs and fingerprints already in queue to prevent duplicate additions
